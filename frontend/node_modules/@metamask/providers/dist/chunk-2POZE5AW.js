...
function createRpcWarningMiddleware(log) {
  ...
  return (req, _res, next) => {
    if (!sentWarnings.ethDecryptDeprecation && req.method === "eth_decrypt") {
      log.warn(_chunkALI4B7QIjs.messages_default.warnings.rpc.ethDecryptDeprecation);
      ...
      log.warn(_chunkALI4B7QIjs.messages_default.warnings.rpc.ethGetEncryptionPublicKeyDeprecation);
      ...
      log.warn(_chunkALI4B7QIjs.messages_default.warnings.rpc.walletWatchAssetNFTExperimental);
...
//# sourceMappingURL=chunk-2POZE5AW.js.map