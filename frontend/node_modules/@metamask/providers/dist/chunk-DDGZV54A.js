...
function createExternalExtensionProvider(typeOrId = "stable") {
  ...
  try {
    ...
    provider = new (0, _chunk732OO7W6js.StreamProvider)(pluginStream, {
      jsonRpcStreamName: _chunkTFQXBZWTjs.MetaMaskInpageProviderStreamName,
      logger: console,
      rpcMiddleware: _chunkHIKGM7AJjs.getDefaultExternalMiddleware.call(void 0, console)
    });
    provider.initialize();
  } catch (error) {
...
//# sourceMappingURL=chunk-DDGZV54A.js.map