...
var _BaseProvider = class _BaseProvider extends _safeeventemitter2.default {
  ...
  async request(args) {
    if (!args || typeof args !== "object" || Array.isArray(args)) {
      throw _rpcerrors.rpcErrors.invalidRequest({
        message: _chunkALI4B7QIjs.messages_default.errors.invalidRequestArgs(),
        data: args
      });
    }
    ...
    if (typeof method !== "string" || method.length === 0) {
      throw _rpcerrors.rpcErrors.invalidRequest({
        message: _chunkALI4B7QIjs.messages_default.errors.invalidRequestMethod(),
        data: args
      });
    }
    if (params !== void 0 && !Array.isArray(params) && (typeof params !== "object" || params === null)) {
      throw _rpcerrors.rpcErrors.invalidRequest({
        message: _chunkALI4B7QIjs.messages_default.errors.invalidRequestParams(),
        data: args
      });
    }
    ...
    return new Promise((resolve, reject) => {
      this._rpcRequest(payload, _chunkHIKGM7AJjs.getRpcPromiseCallback.call(void 0, resolve, reject));
    });
  }
  //====================
  // Private Methods
  ...
  _handleConnect(chainId) {
    if (!this._state.isConnected) {
      ...
      this._log.debug(_chunkALI4B7QIjs.messages_default.info.connected(chainId));
    }
  }
  /**
   ...
   */
  _handleDisconnect(errorMessage) {
    if (this._state.isConnected || !this._state.isPermanentlyDisconnected) {
      this._state.isConnected = false;
      const error = new (0, _rpcerrors.JsonRpcError)(
        1011,
        // Internal error
        _nullishCoalesce(errorMessage, () => ( _chunkALI4B7QIjs.messages_default.errors.permanentlyDisconnected()))
      );
  ...
  _handleChainChanged({
    ...
    if (!_chunkHIKGM7AJjs.isValidChainId.call(void 0, chainId)) {
      this._log.error(_chunkALI4B7QIjs.messages_default.errors.invalidNetworkParams(), { chainId });
      return;
    }
    this._handleConnect(chainId);
...
//# sourceMappingURL=chunk-3SH27QO5.js.map