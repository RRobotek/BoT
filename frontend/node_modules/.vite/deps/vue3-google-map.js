...
(function() {
  ...
  try {
    if (typeof document < "u") {
      ...
      a.appendChild(document.createTextNode(".mapdiv[data-v-dbf82c40]{width:100%;height:100%}.custom-control-wrapper[data-v-d099a3a6]{display:none}.mapdiv .custom-control-wrapper[data-v-d099a3a6]{display:inline-block}.info-window-wrapper[data-v-cbe1707b]{display:none}.mapdiv .info-window-wrapper[data-v-cbe1707b]{display:inline-block}.custom-marker-wrapper[data-v-2d2d343a]{display:none}.mapdiv .custom-marker-wrapper[data-v-2d2d343a]{display:inline-block}")), document.head.appendChild(a);
    }
  } catch (d) {
...
var T = class _T {
  ...
  constructor({ apiKey: e, authReferrerPolicy: t, channel: s, client: r, id: o = de, language: a, libraries: l = [], mapIds: i, nonce: d, region: u, retries: c = 3, url: h = "https://maps.googleapis.com/maps/api/js", version: p }) {
    if (this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = e, this.authReferrerPolicy = t, this.channel = s, this.client = r, this.id = o || de, this.language = a, this.libraries = l, this.mapIds = i, this.nonce = d, this.region = u, this.retries = c, this.url = h, this.version = p, _T.instance) {
      if (!De(this.options, _T.instance.options))
...
var Et = te(Ve, [["render", Ge], ["__scopeId", "data-v-dbf82c40"]]);
function He(n3) {
...
var _e = Math.fround || /* @__PURE__ */ ((n3) => (e) => (n3[0] = +e, n3[0]))(new Float32Array(1));
var A = 2;
var S = 3;
var oe = 4;
var L = 5;
...
var ue = class _ue {
  constructor() {
    gt(_ue, google.maps.OverlayView);
  }
};
var j;
(function(n3) {
      ...
      () => {
        o.value && (r.value = markRaw(
          new yt({
            ...
            algorithm: new pt(n3.options.algorithmOptions ?? {}),
            ...n3.options
          })
        ), be.forEach((l) => {
          var i;
